...
CREATE DATABASE IF NOT EXISTS questionari_app CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE questionari_app;
...
CREATE TABLE compilazioni (
    ...
    -- Risposte complete in JSON
    completata BOOLEAN DEFAULT FALSE,
    tempo_impiegato INT,
    -- Tempo in secondi (utile per analisi)
        ...
        JSON_OBJECT(
            ...
            JSON_ARRAY(
                JSON_OBJECT(
                    ...
                    true,
                    'options',
                    JSON_ARRAY('Ottima', 'Buona', 'Sufficiente', 'Scarsa')
                ),
                JSON_OBJECT(
                    'id',
                    2,
        ...
        JSON_OBJECT(
            ...
            JSON_ARRAY(
                JSON_OBJECT(
                    ...
                    'checkbox',
                    'question',
                    'Quali argomenti hai trovato interessanti?',
                    'required',
                    true,
                    'options',
                    JSON_ARRAY(
                ...
                JSON_OBJECT(
                    ...
                    'number',
                    'question',
                    'Quante ore hai dedicato allo studio?',
                    'required',
                    true
                ),
                JSON_OBJECT(
...
VALUES (
        ...
        JSON_OBJECT(
            ...
            9,
            '3',
            'Lezione molto chiara e ben strutturata'
        ),
        true,
        180
    ),
    ...
    (
        ...
        JSON_OBJECT(
            '1',
            JSON_ARRAY('Teoria', 'Esempi pratici'),
            '2',
            3,
            '3',
            'Più esercizi pratici'
        ),
        true,
        200
    ),
    (
        ...
        JSON_OBJECT(
            '1',
            JSON_ARRAY('Esempi pratici', 'Discussione'),
            '2',
            2,
            '3',
            ''
...
SELECT COUNT(*) as relatori
FROM relatori;
SELECT COUNT(*) as utenti
FROM utenti;
SELECT COUNT(*) as lezioni
FROM lezioni;
SELECT COUNT(*) as questionari
FROM questionari;
